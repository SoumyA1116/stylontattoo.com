...
const Footer: React.FC = () => {
  // Encoded address for backup links
  const mapAddress = encodeURIComponent(STUDIO_DATA.address);
  ...
  return (
    <footer id="contact" className="pt-24 pb-12 bg-black relative">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="col-span-1 md:col-span-2">
            ...
            <div className="mb-6 overflow-hidden rounded-xl border border-white/10 liquid-border h-64 group relative bg-zinc-900">
              {/* User provided specific Google Maps Embed */}
              <iframe 
            ...
            >
              <span className="heading-font uppercase tracking-[0.3em] text-[10px] font-bold">Open in Google Maps</span>
          ...
          <div>
            <h4 className="heading-font uppercase tracking-widest mb-6 border-b border-gray-800 pb-2 text-white">Information</h4>
            <ul className="space-y-4 text-gray-400">
              <li><a href="#about" className="hover:text-[#d4af37] transition-colors">About Studio</a></li>
              <li><a href="#styles" className="hover:text-[#d4af37] transition-colors">Styles Offered</a></li>
              <li><a href="#gallery" className="hover:text-[#d4af37] transition-colors">Gallery</a></li>
              <li><a href="#aftercare" className="hover:text-[#d4af37] transition-colors">Aftercare Tips</a></li>
            </ul>
          </div>

          <div>
            <h4 className="heading-font uppercase tracking-widest mb-6 border-b border-gray-800 pb-2 text-white">Location</h4>
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <p className="text-gray-400 text-sm">{STUDIO_DATA.hours}</p>
              </div>
              <div className="flex items-start space-x-3">
                <i className="fas fa-phone text-[#d4af37] mt-1"></i>
                <p className="text-[#d4af37] font-bold tracking-widest">{STUDIO_DATA.phone}</p>
              </div>
            </div>
          </div>
        </div>

        <div className="border-t border-gray-900 pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 text-[10px] uppercase tracking-[0.3em]">
      ...
      <a 
        ...
        className="fixed bottom-10 right-10 z-[110] bg-[#25D366] text-white w-14 h-14 rounded-full flex items-center justify-center shadow-[0_0_30px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform md:hidden"
      >
